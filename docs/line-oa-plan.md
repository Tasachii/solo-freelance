...
### เลือก: OA ของครูแต่ละคน ไม่ใช่ OA กลางของ Solo

เหตุผลเดียวที่พอ: **หลักการข้อ 5 ห้ามข้อความถึงลูกค้ามีคำว่า "Solo"** — OA กลางทำให้ผู้ปกครองได้ข้อความจากบัญชีบริษัทที่เขาไม่รู้จัก ผิดหลักการที่ล็อกไว้แล้ว และ Solo ต้องจ่ายค่าข้อความทุกใบเมื่อโต
...
โควตาฟรี 300 ข้อความ/เดือนเป็นของ OA แต่ละบัญชี = ของครู ไม่ใช่ของเรา ถ้าเกิน **ครูเป็นคนถูก LINE เรียกเก็บ** ซึ่งแพงกว่าค่า Solo หลายเท่า — ห้ามปล่อยให้เกิดขึ้นโดยครูไม่รู้ตัว
...
| # | commit | เนื้อหา |
|---|---|---|
| 1 | `feat(line): schema` | 4 ตาราง + RLS + view ที่ซ่อน token |
