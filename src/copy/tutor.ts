...
export const tutorTemplates = {
  ...
  reminder: {
    soft: 'เรียน{clientHonorific}{clientName} ขออนุญาตแจ้งเตือนค่าเรียน{subjectName} เดือน{periodThai} {total} บาท ยังไม่ได้รับยอดครับ ดูรายละเอียดชำระเงินที่ {invoiceUrl} ครับ 🙏',
  ...
  renewal:
    'เรียน{clientHonorific}{clientName} แพ็ก {packageTotal} ครั้งของ{subjectName} เหลืออีก {remaining} ครั้งครับ ต่อแพ็กใหม่ {packageTotal} ครั้ง {packagePrice} บาท ดูรายละเอียดชำระเงินที่ {invoiceUrl} ครับ',
  renewalExhausted:
  ...
  faq: {
    currentInvoice: 'เดือน{periodThai} {subjectName}เรียน {qty} ครั้ง รวม {total} บาทครับ ดูรายละเอียดชำระเงินที่ {invoiceUrl}',
